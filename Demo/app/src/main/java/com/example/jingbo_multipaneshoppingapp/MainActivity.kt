...
val products = listOf(
    ...
    Product("Product F", "$300", "This is my favorite product E ."),
    Product("Product G", "$300", "This is my favorite product E ."),
    Product("Product H", "$300", "This is my favorite product E ."),
    Product("Product I", "$300", "This is my favorite product E ."),
    Product("Product J", "$300", "This is my favorite product E ."),
    Product("Product K", "$300", "This is my favorite product E ."),
    Product("Product L", "$300", "This is my favorite product E ."),
    Product("Product M", "$300", "This is my favorite product E ."),
)
